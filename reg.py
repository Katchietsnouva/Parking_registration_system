...
entry1.configure(font=('italic', 10))
...
entry2.configure(font=('italic', 10))
...
entry3.configure(font=('italic', 10))
...
entry4.configure(font=('italic', 10))
...
entry5.configure(font=('italic', 10))
...
entry6.configure(font=('italic', 10))
