...
# # Form label
# img1 = ImageTk.PhotoImage(Image.open("logo.png"))
# Label_frame = ctk.CTkLabel(root, text="Registraton Form", font=("ar", 15, "bold"), image=img1)
# Label_frame.pack(padx=20, pady=20, fill=ctk.BOTH, expand=True)

# # Disable the clipping of the label's content, allowing the image to remain visible
# Label_frame.clip = False
...
# # Pack the Label_frame after modifying its clip property
# Label_frame.pack(padx=20, pady=20, fill=ctk.BOTH, expand=True)
